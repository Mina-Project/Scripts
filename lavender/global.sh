...
### Clone AnyKernel3 ###
git clone https://github.com/Mina-Project/AnyKernel3 -b $AK_BRANCH ${ZIP_DIR}
###### Telegram Function #####
BOT_API_KEY=$(openssl enc -base64 -d <<< "${token}")
BUILD_FAIL="CAACAgQAAx0CUPRqKwACFWBellgcUeTWUj_MRWJLz6Czd9cokwACUwwAAskpHQ8go8px5eh4ihgE"
BUILD_SUCCESS="CAACAgUAAx0CUPRqKwACFWRellg9L_iFa20dCci4wyL0Pr2xKgACJQEAAna2lSii1C6TeMVizRgE"
